$(function () {
    ...
    function getImgSrc(piece) {
        return config.pieceTheme.replace('{piece}', game.turn() + piece.toLocaleUpperCase());
    }
    ...
    var onDrop = function (source, target) {
        ...
        if (piece === 'p' &&
            ((source_rank === '7' && target_rank === '8') || (source_rank === '2' && target_rank ===
                '1'))) {
            promoting = true;
    ...
    function pgnHeader() {
        ...
        var fenstr = '<li class="tinygreen">' + game.fen() + '"]</li>';
        $pgn.append('<li class="tinygreen">[SetUp "1"] [StartPos ' + fenstr + '</li>');
    }
